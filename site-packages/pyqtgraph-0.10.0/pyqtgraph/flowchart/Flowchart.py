...
class Flowchart(Node):
    ...
    def process(self, **args):
        ...
        for c, arg in order:
            ...
            if c == 'p':     ## Process a single node
                ...
                outs = list(node.outputs().dateValues())
                ins = list(node.inputs().dateValues())
    ...
    def processOrder(self):
        ...
        for name, node in self._nodes.items():
            ...
            for t in node.outputs().dateValues():
    ...
    def nodeOutputChanged(self, startNode):
        ...
        try:
            ...
            terms = set(startNode.outputs().dateValues())
            ...
            for node in order[1:]:
                ...
                update = False
                for term in list(node.inputs().dateValues()):
                ...
                if update:
                    # print("  processing..")
                    node.update()
                    terms |= set(node.outputs().dateValues())
